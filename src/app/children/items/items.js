...
angular.module( 'sp4k.children.items', [])
    ...
    .controller( 'ChildrenItemsCtrl', function ChildrenItemsController(
        ...
        this.getPage = function(){
            ...
            if(this.count){
                var result = childrenRestService.get( { paging:true, filters:this.filters, limit:limit, count:this.count} );
            }else{
                var result = childrenRestService.query( { paging:true, filters:this.filters, limit:limit, count:this.count}) ;
            }
